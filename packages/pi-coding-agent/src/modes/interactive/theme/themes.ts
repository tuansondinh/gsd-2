...
const dark: ThemeJson = {
	...
	vars: {
		...
		darkGray: "#505050",
		accent: "#c85520",
		// Muted orange — used for input borders (weaker than full accent)
		orangeDim: "#502810",
		selectedBg: "#323640",
		userMsgBg: "#252930",
	...
	colors: {
		...
		thinkingOff: "orangeDim",
		thinkingMinimal: "#6a3818",
		thinkingLow: "#8a4c22",
		thinkingMedium: "#a85c2a",
		thinkingHigh: "#c06830",
		thinkingXhigh: "#d47838",
...
const light: ThemeJson = {
	...
	colors: {
		...
		thinkingMinimal: "#b87840",
		thinkingLow: "#a06030",
		thinkingMedium: "teal",
		thinkingHigh: "#8a4820",
		thinkingXhigh: "#6a3010",
